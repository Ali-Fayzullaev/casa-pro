    ...
    return (
        <div className={cn("absolute inset-0 bg-white/95 backdrop-blur-sm z-50 flex flex-col items-center justify-center p-4 text-center animate-in fade-in duration-300", className)}>
            <div className="relative mb-4">
                ...
                <Brain className="w-10 h-10 text-indigo-600 animate-bounce relative z-10" />
                <Sparkles className="w-4 h-4 text-yellow-400 absolute -top-1 -right-1 animate-spin-slow" />
            </div>

            <h4 className="font-semibold text-indigo-900 mb-1">DeepSeek AI</h4>
            <p className="text-sm text-indigo-600/80 min-h-[1.5em] transition-all duration-300">
                {MESSAGES[msgIndex]}
            </p>
